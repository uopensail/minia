...
const std::unordered_map<std::string, Function> builtins = {
    ...
    {"cosh:1=[1]", get_func<std::coshf, float>()},
    {"cosh:1=[0]", get_func<std::coshf, int64_t>()},
    {"cosh:1=[3]", get_func<repeat_apply<std::coshf, std::vector<int64_t>>,
                            std::vector<int64_t>>()},
    {"cosh:1=[4]", get_func<repeat_apply<std::coshf, std::vector<float>>,
                            std::vector<float>>()},

    {"cos:1=[1]", get_func<std::cosf, float>()},
    {"cos:1=[0]", get_func<std::cosf, int64_t>()},
    {"cos:1=[3]", get_func<repeat_apply<std::cosf, std::vector<int64_t>>,
                           std::vector<int64_t>>()},
    {"cos:1=[4]", get_func<repeat_apply<std::cosf, std::vector<float>>,
                           std::vector<float>>()},

    {"exp:1=[1]", get_func<std::expf, float>()},
    {"exp:1=[0]", get_func<std::expf, int64_t>()},
    {"exp:1=[3]", get_func<repeat_apply<std::expf, std::vector<int64_t>>,
                           std::vector<int64_t>>()},
    {"exp:1=[4]", get_func<repeat_apply<std::expf, std::vector<float>>,
                           std::vector<float>>()},

    {"log:1=[1]", get_func<std::logf, float>()},
    {"log:1=[0]", get_func<std::logf, int64_t>()},
    {"log:1=[3]", get_func<repeat_apply<std::logf, std::vector<int64_t>>,
                           std::vector<int64_t>>()},
    {"log:1=[4]", get_func<repeat_apply<std::logf, std::vector<float>>,
                           std::vector<float>>()},

    {"log10:1=[1]", get_func<std::log10f, float>()},
    {"log10:1=[0]", get_func<std::log10f, int64_t>()},
    {"log10:1=[3]", get_func<repeat_apply<std::log10f, std::vector<int64_t>>,
                             std::vector<int64_t>>()},
    {"log10:1=[4]", get_func<repeat_apply<std::log10f, std::vector<float>>,
                             std::vector<float>>()},

    {"log2:1=[1]", get_func<std::log2f, float>()},
    {"log2:1=[0]", get_func<std::log2f, int64_t>()},
    {"log2:1=[3]", get_func<repeat_apply<std::log2f, std::vector<int64_t>>,
                            std::vector<int64_t>>()},
    {"log2:1=[4]", get_func<repeat_apply<std::log2f, std::vector<float>>,
                            std::vector<float>>()},

    {"sqrt:1=[1]", get_func<std::sqrtf, float>()},
    {"sqrt:1=[0]", get_func<std::sqrtf, int64_t>()},
    {"sqrt:1=[3]", get_func<repeat_apply<std::sqrtf, std::vector<int64_t>>,
                            std::vector<int64_t>>()},
    {"sqrt:1=[4]", get_func<repeat_apply<std::sqrtf, std::vector<float>>,
                            std::vector<float>>()},
    ...
    {"sinh:1=[1]", get_func<std::sinhf, float>()},
    {"sinh:1=[0]", get_func<std::sinhf, int64_t>()},
    {"sinh:1=[3]", get_func<repeat_apply<std::sinhf, std::vector<int64_t>>,
                            std::vector<int64_t>>()},
    {"sinh:1=[4]", get_func<repeat_apply<std::sinhf, std::vector<float>>,
                            std::vector<float>>()},

    {"sin:1=[1]", get_func<std::sinf, float>()},
    {"sin:1=[0]", get_func<std::sinf, int64_t>()},
    {"sin:1=[3]", get_func<repeat_apply<std::sinf, std::vector<int64_t>>,
                           std::vector<int64_t>>()},
    {"sin:1=[4]", get_func<repeat_apply<std::sinf, std::vector<float>>,
                           std::vector<float>>()},

    {"tanh:1=[1]", get_func<std::tanhf, float>()},
    {"tanh:1=[0]", get_func<std::tanhf, int64_t>()},
    {"tanh:1=[3]", get_func<repeat_apply<std::tanhf, std::vector<int64_t>>,
                            std::vector<int64_t>>()},
    {"tanh:1=[4]", get_func<repeat_apply<std::tanhf, std::vector<float>>,
                            std::vector<float>>()},

    {"pow:2=[0,0]", get_func<std::powf, int64_t, int64_t>()},
    {"pow:2=[0,1]", get_func<std::powf, int64_t, float>()},
    {"pow:2=[1,0]", get_func<std::powf, float, int64_t>()},
    {"pow:2=[1,1]", get_func<std::powf, float, float>()},
    {"pow:2=[3,0]",
     get_func<repeat_apply<std::powf, std::vector<int64_t>, int64_t>,
              std::vector<int64_t>, int64_t>()},
    {"pow:2=[4,0]",
     get_func<repeat_apply<std::powf, std::vector<float>, int64_t>,
              std::vector<float>, int64_t>()},
    {"pow:2=[3,1]",
     get_func<repeat_apply<std::powf, std::vector<int64_t>, float>,
              std::vector<int64_t>, float>()},
    {"pow:2=[4,1]", get_func<repeat_apply<std::powf, std::vector<float>, float>,
                             std::vector<float>, float>()},
