...
const std::unordered_map<std::string, Function> builtins = {
    ...
    {"cosh:1=[3]", get_func<repeat_apply<coshf, std::vector<int64_t>>,
                            std::vector<int64_t>>()},
    {"cosh:1=[4]", get_func<repeat_apply<coshf, std::vector<float>>,
                            std::vector<float>>()},
    ...
    {"cos:1=[3]", get_func<repeat_apply<cosf, std::vector<int64_t>>,
                           std::vector<int64_t>>()},
    {"cos:1=[4]", get_func<repeat_apply<cosf, std::vector<float>>,
                           std::vector<float>>()},
    ...
    {"exp:1=[3]", get_func<repeat_apply<expf, std::vector<int64_t>>,
                           std::vector<int64_t>>()},
    {"exp:1=[4]", get_func<repeat_apply<expf, std::vector<float>>,
                           std::vector<float>>()},
    ...
    {"log:1=[3]", get_func<repeat_apply<logf, std::vector<int64_t>>,
                           std::vector<int64_t>>()},
    {"log:1=[4]", get_func<repeat_apply<logf, std::vector<float>>,
                           std::vector<float>>()},
    ...
    {"log2:1=[3]", get_func<repeat_apply<log2f, std::vector<int64_t>>,
                            std::vector<int64_t>>()},
    {"log2:1=[4]", get_func<repeat_apply<log2f, std::vector<float>>,
                            std::vector<float>>()},
    ...
    {"sqrt:1=[3]", get_func<repeat_apply<sqrtf, std::vector<int64_t>>,
                            std::vector<int64_t>>()},
    {"sqrt:1=[4]", get_func<repeat_apply<sqrtf, std::vector<float>>,
                            std::vector<float>>()},
    ...
    {"sinh:1=[3]", get_func<repeat_apply<sinhf, std::vector<int64_t>>,
                            std::vector<int64_t>>()},
    {"sinh:1=[4]", get_func<repeat_apply<sinhf, std::vector<float>>,
                            std::vector<float>>()},
    ...
    {"sin:1=[3]", get_func<repeat_apply<sinf, std::vector<int64_t>>,
                           std::vector<int64_t>>()},
    {"sin:1=[4]", get_func<repeat_apply<sinf, std::vector<float>>,
                           std::vector<float>>()},
    ...
    {"tanh:1=[3]", get_func<repeat_apply<tanhf, std::vector<int64_t>>,
                            std::vector<int64_t>>()},
    {"tanh:1=[4]", get_func<repeat_apply<tanhf, std::vector<float>>,
                            std::vector<float>>()},
    ...
    {"pow:2=[3,0]",
     get_func<repeat_apply<powf, std::vector<int64_t>, int64_t>,
              std::vector<int64_t>, int64_t>()},
    {"pow:2=[4,0]",
     get_func<repeat_apply<powf, std::vector<float>, int64_t>,
              std::vector<float>, int64_t>()},
    {"pow:2=[3,1]",
     get_func<repeat_apply<powf, std::vector<int64_t>, float>,
              std::vector<int64_t>, float>()},
